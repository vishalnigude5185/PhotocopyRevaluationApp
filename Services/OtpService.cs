...
using PhotocopyRevaluationAppMVC.Controllers;
using System.Text;
...
namespace PhotocopyRevaluationAppMVC.Services
{
    public class OtpService : IOtpService
    {
        ...
        public OtpService(SMSService smsService, EmailService emailService, IHttpContextAccessor httpContextAccessor, ILogger<AccountsController> logger, Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache)
        {
